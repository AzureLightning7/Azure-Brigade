...
public class PlayerControllerThree : MonoBehaviour
{
    ...
    UIManagerThree uiManager;  // reference to UI for lives image
    ...
    void Start()
    {
        ...
        uiManager = GameObject.Find("CanvasThree").GetComponent<UIManagerThree>();
        if (uiManager != null)
    ...
    public void TakeDamage()
    {
        ...
        if (lives <= 0)
        {
            ...
            MusicController music = myCamera.GetComponent<MusicController>();
            music.EndMusic();
            uiManager.GameOver();
        }
    }
